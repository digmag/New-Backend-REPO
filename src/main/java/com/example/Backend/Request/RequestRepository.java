...
public interface RequestRepository extends JpaRepository<RequestEntity, UUID> {
    ...
    List<RequestEntity> findAllByKeyAndRequestedDateTimeAndStatusOrStatus(KeyEntity keyEntity, LocalDateTime requestedDateTime, RequestStatus status1, RequestStatus status2);
